...
import { Search, Plane, TrendingDown, Shield, MapPin, Star, ArrowRight, Sparkles, Calendar, Users, ChevronDown, Briefcase, GraduationCap } from 'lucide-react'
                                    ...
                                    <div className="flex flex-col lg:flex-row gap-3">
                                        <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-3">
                                            <label className="relative group cursor-text">
                                                <Plane className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-dark-400 group-focus-within:text-primary-400 transition-colors pointer-events-none z-10" />
                                                <input
                                                    type="text"
                                                    value={from}
                                            ...
                                            <label className="relative group cursor-text">
                                                <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-dark-400 group-focus-within:text-primary-400 transition-colors pointer-events-none z-10" />
                                                <input
                                                    type="text"
                                                    value={to}
